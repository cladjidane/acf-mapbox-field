...
if (!class_exists('K_acf_field_bounds_map')) :


	class K_acf_field_bounds_map extends acf_field
	{
	...
	*/
		...
		*  var message = acf._e('bounds_map', 'error');
		*/
...
?>
			<div id="root" data-value="<?php echo esc_attr($field['value']) ?>"></div>
...
<?php
	...
	*/
	...
	// initialize
	new K_acf_field_bounds_map($this->settings);
